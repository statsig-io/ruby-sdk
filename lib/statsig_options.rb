...
class StatsigOptions
  ...
  sig { returns(T.any(Method, Proc, NilClass)) }
  # A callback function to customize backoff time
  # Expects a single Integer parameter indicating remaining number retries
  ...
  sig do
    params(
      ...
      post_logs_retry_backoff: T.any(Method, Proc, NilClass)
    ).void
  end
